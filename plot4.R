...
# Create four separate plots side by side that
# Show time vs. Global Active Power
# Show time vs. Voltage
# Show time vs. sub-meterings 1 through 3, and
# Show time vs. global reactive power.
# Print it as a PNG file.
